...
import com.nuite.entity.ColumnEntity;
import com.nuite.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "com.nuite" : mainPath;
	...
	public static String columnToJava(String columnName) {
		//将首字母和所有分隔符"_"后的第一个子母转为大写，并去掉分隔符"_"，同时将其他字母全部转为小写。
//		return WordUtils.capitalizeFully(columnName, new char[]{'_'}).replace("_", "");
		//将首字母和所有分隔符"_"后的第一个子母转为大写，并去掉分隔符"_"，其他字母不变。
